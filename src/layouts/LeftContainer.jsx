...
import BoxPannel from "./BoxPanel/BoxPannel.jsx";
...
export default function LeftContainer() {
  ...
  return (
    <div className="relative mt-20 w-[600px] h-[620px] border rounded-b rounded-tr border-gray-300 shadow-xl bg-gray-50 md:mt-0">
